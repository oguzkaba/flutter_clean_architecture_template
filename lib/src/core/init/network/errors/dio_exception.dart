...
String handleDioExceptions(DioException error) {
  ...
  switch (error.type) {
    ...
    case DioExceptionType.connectionTimeout:
      errorDescription =
          'Connection timeout with server or no internet connection';
  ...
  return errorDescription is String ? errorDescription : 'Unknown Error';
}
